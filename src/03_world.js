...
function buildBeachCourt() {
  ...
  const water = new THREE.Mesh(new THREE.PlaneGeometry(160, 300), mat(0x3fb4e6, { roughness: .8 })); water.rotation.x = -Math.PI / 2; water.position.set(50 + 80, -0.02, 0); beachCourt.add(water);   // sea along the +x side, from the shore line at x = 50 outward
